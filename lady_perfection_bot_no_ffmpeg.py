...
async def handle_voice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Обработка голосовых сообщений - упрощенная версия без FFmpeg."""
    try:
        # Отправляем сообщение о том, что голосовые сообщения временно недоступны
        await update.message.reply_text(
            "🎤 Голосовые сообщения временно недоступны.\n\n"
            "Для работы с голосовыми сообщениями требуется установка FFmpeg.\n\n"
            "💡 Пожалуйста, отправьте текстовое сообщение, и я с удовольствием помогу вам!"
        )
        ...
        await update.message.reply_text(
            "💬 Напишите мне ваш вопрос, и я отвечу вам с эмпатией и профессионализмом!",
...
def main() -> None:
    ...
    try:
        ...
        print("🤖 Запуск бота Мэри П. (без FFmpeg)...")
        print("✅ Бот готов к работе!")
        print("📱 Найдите бота в Telegram и нажмите /start")
        print("💡 Голосовые сообщения временно недоступны")
