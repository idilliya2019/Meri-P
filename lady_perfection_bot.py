...
# Добавляем обработчик для аудиофайлов (если пользователь отправляет аудио как файл)
async def handle_audio(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        wav_path = f"audio_{update.message.message_id}.wav"
        ...
        await update.message.reply_text("❌ Не удалось обработать аудиофайл. Попробуйте отправить голосовое сообщение или текст.")
